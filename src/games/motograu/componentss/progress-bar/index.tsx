...
export default function ProgressBar({
  ...
  return (
    <div className="w-full relative flex flex-col gap-2 items-center">
      <small 
        className="font-black text-center text-base sm:text-lg md:text-xl lg:text-2xl flex items-center justify-center uppercase drop-shadow font-bungeeSpice"
        >
        {label}
      </small>
      ...
      <span
        className="text-4xl sm:text-6xl md:text-6xl lg:text-6xl font-bold  flex items-center justify-center bg-gradient-to-t from-[#ff7700] to-[#ffa300] text-transparent bg-clip-text drop-shadow"
        style={{
